namespace PLCSE
{
	public static class Helpers 
	{
		...
		private static string[] TrackerNames = new[] { "Tracker Missile", "W.D. Special", "Shield Piercer", "MAX", "SHIELD_FOCUS", "Reactor Buster", "Straight Shot", "Acid Missile", "Armor Piercing Missile", "System Damage Missile", "F.B. Missile", "Torpedo" };
		...
		private static string[] PolytechModuleNames = new[] { "P.T. Module: Shields", "P.T. Module: Damage", "P.T. Module: Quantum Charger", "P.T. Module: Rapid Assembly", "P.T. Module: Crew Repair Nano-bots", "P.T. Module: Thrust" };
		private static string[] FBRecipeNames = new[] { "Classic Biscuit Recipe", "Emergency Biscuit Recipe", "Healthy Biscuit Recipe", "Carrot Cake Biscuit Recipe", "Hearty Biscuit Recipe", "Whole Wheat Biscuit Recipe", "Healberry Crumbly Biscuit Recipe", "Sugar Biscuit Recipe", "Garlic Biscuit Recipe", "Frozen Biscuit Recipe", "Spicy Biscuit Recipe", "Spicy Crumbly Biscuit Recipe", "Grenade Damage Biscuit Recipe", "Lucky Biscuit Recipe", "Molten Biscuit Recipe", "Long Life Biscuit Recipe", "Funky Biscuit Recipe" };
		...
		public static string DecodeNameForComponent(uint inHash)
		{
			...
			try
			{
				switch (type)
				{
					...
					case 8:
						return $"{(subtype == 0 ? "Standard O2 Generator" : subtype == 1 ? "\"Calypso\" O2 Generator" : "Modded Oxygen Generator")} {level} lvl";
					case 9:
					...
					case 22:
						return $"{(subtype == 0 ? "400 MHz" : subtype == 1 ? "580.8 MHz" : "200 MHz")} {level} lvl";
					case 23:
					...
					case 30:
						return FBRecipeNames[subtype] + $" {level} lvl";
					case 31:
					...
					case 34:
						return PolytechModuleNames[subtype] + $" {level} lvl";
					case 35:
						return $"Powered Armor {level} lvl";
					default:
